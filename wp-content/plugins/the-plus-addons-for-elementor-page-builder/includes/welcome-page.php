		...
		echo '<div class="theplus-panel-col theplus-panel-col-65">';
			...
			echo '<div class="theplus-panel-sec theplus-p-20 theplus-welcome-changelog theplus-mb-8">';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">DEC 15,2020 <span class="changelog-version">Lite Version 2.0.2</span></div>';
						echo '<ul class="changelog-list">';
							echo '<li>'.esc_html__('WordPress 5.6 Compatibility & jQuery Updates','tpebl').'</li>';
							echo '<li>'.esc_html__('Accordion : Support Icon Library','tpebl').'</li>';
				...
				echo '<div class="theplus-changelog-list">';
					echo '<div class="changelog-date">DEC 15,2020 <span class="changelog-version">Pro Version 4.1.2</span></div>';
						echo '<ul class="changelog-list">';							
							echo '<li>'.esc_html__('WordPress 5.6 Compatibility & jQuery Updates','tpebl').'</li>';
							echo '<li>'.esc_html__('Pricing List : Title Padding Responsive option','tpebl').'</li>';
							echo '<li>'.esc_html__('Hotspot : Common Styling options','tpebl').'</li>';
							echo '<li>'.esc_html__('Support of Icon Library in Popular Widgets','tpebl').'</li>';
							echo '<li>'.esc_html__('All static icons moved from Font Awesome 4 to Font Awesome 5','tpebl').'</li>';
							echo '<li>'.esc_html__('Blog Listing & Dynamic Listing : Preloader Option in Grid and Masonry Layout','tpebl').'</li>';
							echo '<li>'.esc_html__('Login/Register : Enable/Disable Login/Register to Reset Form option','tpebl').'</li>';
